class Player{
    ...
    display(){        
        ...
        if(this.dashed == false){
            if(this.sprite.velocityX > 10){
                this.sprite.velocityX = 10;
            }
            else if (this.sprite.velocityX < -10){
                this.sprite.velocityX = -10;
            }
        }
        else{
            if(this.sprite.velocityX > 20){
                this.sprite.velocityX = 20;
            }
            else if (this.sprite.velocityX < -20){
                this.sprite.velocityX = -20;
            }
        }
    ...
    movement(){
        ...
        // Jump
        if(keyDown(32) && this.isGrounded == true && gameState != "end"){
            playerSprite.velocityY -= this.jumpForce;
            this.spaceReleased = false;
        }

        // Dash
        if(keyDown(16) && this.dashed == false){
        ...
        // Air Dash
        if(keyDown(16) && this.isGrounded == false && this.airDashed == false){
            if(this.facingRight == true){
                playerSprite.velocityX += this.jumpForce;
                playerSprite.velocityY = 0;
                this.adSFX.play();
    ...
    animation(){
        ...
        if(this.isGrounded == true){
            if(this.sprite.velocityX < 0.7 && this.sprite.velocityX > -0.7){
                this.sprite.changeAnimation("Idle");
                this.sprite.velocityX = 0;
                this.dashed = false;
            }
            else if (this.sprite.velocityX > 0.7 && this.sprite.velocityX < 12 || this.sprite.velocityX < -0.7 && this.sprite.velocityX > -12){
